...
int main()
{
    ...
    button btnHe = {750,500,150,75,"ПОМОЩЬ",TX_WHITE,TX_RED,30};
    ...
    square sq  = {30,900,270,130,"Сдать цветы",true};
    ...
    while (page != "exit")
    {
        ...
        if(page == "menu")
        {
            btnSt.draw();
            btnHe.draw();
            btnEx.x = 1000; btnEx.y = 750; btnEx.text = "УЙТИ";
            btnEx.draw();
        ...
        if(page == "help")
        {
            btnEx.x = 1750; btnEx.y = 900; btnEx.text = "НАЗАД"; btnEx.draw();
            txSetColor(TX_WHITE);
            txSelectFont ("Comic Sans MS", 60);
            txDrawText(0,250,1920,1080,"   УПРАВЛЕНИЕ:\n"
                       "W - идти вврех \n"
                       "A - идти влево\n"
                       "S - идти вниз\n"
                       "D - идти вправо\n" "\n"
                       "   ГЕЙМПЛЕЙ:\n"
                       "Доверяй бабушке и кошкам,обращай внимание на здоровье\n" "\n");
            if( txMouseButtons() == 1 and
                btnEx.x < txMouseX() and txMouseX() < btnEx.w + btnEx.x and
                btnEx.y < txMouseY() and txMouseY() < btnEx.y + btnEx.h)
            {
  ...
  n      {
        ...
        if(page == "dom")
        {
            if (sten == false and kvest == false and fight == false and done == false)
            {
                ...
                G.draw();
                DI.x = 550; DI.y = 475; DI.r = 50; DI.v = true; DI.text = "Привет котенок, что ты тут делаешь?"; DI.draw();
                btnV1.draw();
                btnV2.draw();
                nKad=0;
                if( txMouseButtons() == 1 and
            ...
            if(sten == true and page == "dom" and kvest == false and fight == false)
            {
                ...
                while (vibor == true)
                {
                        ...
                        btnV1.y < txMouseY() and txMouseY() < btnV1.y + btnV1.h)
                    {
                        ...
                        txBitBlt(txDC(),0,0,1920,1080,house);
                        G.x = 150; G.draw();
                        DI.text = "Ко мне просто так не заселиться \n" "тебе предстоит пройти мое испытание"; DI.draw();
                        txSleep(3500);
                        DI.text = "Ну, приступим"; DI.draw();
                        txSleep(2500);
                        DI.text = "Этим испытанием будет"; DI.draw();
                        txSleep(2500);
            ...
            if(done == true)
            {
                ...
                G.n = 0; G.draw();
                DI.x = 550; DI.y = 475; DI.r = 50;
                DI.text = "Так погоди, тут надо посчитать";  DI.draw();
                txSleep(5555);
                if(point <3)
                {
                    DI.text = "Так так так так";  DI.draw();
                    txSleep(3555);
                    DI.text = "Мне жаль, но ты не достоин \n" "жить у меня";  DI.draw();
                    txSleep(2555);
                    DI.text = "убирайся....";  DI.draw();
                    txSleep(2555);
                    page = "lose";
                }
                if(point >2)
                {
                    DI.text = "Так так так так";  DI.draw();
                    txSleep(3555);
                    DI.text = "Иииииииииииииии";  DI.draw();
                    txSleep(2555);
                    DI.text = "Я тебя поздравляю!\n" "ты будешь жить со мной!";  DI.draw();
                    txSleep(3555);
                    page = "victory";
                }
            }
        ...
        {
            G.draw();
            DI.x = 550; DI.y = 475; DI.r = 50; DI.v = true; DI.text = "Пришло время испытания!"; DI.draw();
            txSleep(2500);
        ...
        if(task1 == false and task2 == true and task3 == false and task4 == false and task == false)
        {
            ...
            G.v = true; G.draw();
            DI.x = 550; DI.y = 475; DI.r = 50; DI.v = true; DI.text = "Теперь второе задание"; DI.draw();
            txSleep(2500);
            DI.text = "Принеси мне 2 астры, \n" "4 подсолнухa, 1 алое, 3 кактусa"; DI.draw();
            txSleep(5000);
            DI.v = false; G.v = false;
            time = 300;
            task = true;
        ...
        if(task1 == false and task2 == false and task3 == true and task4 == false and task == false)
        {
            ...
            G.v = true; G.draw();
            nA = 0; nP = 0; nAl = 0; nC = 0;
            DI.x = 550; DI.y = 475; DI.r = 50; DI.v = true; DI.text = "Теперь третье задание"; DI.draw();
            txSleep(2500);
            DI.text = "Принеси мне 4 астры, \n" "5 подсолнухов, 3 алое, 6 кактусов"; DI.draw();
            txSleep(5000);
            DI.v = false; G.v = false;
            time = 450;
            task = true;        }
        if(task1 == false and task2 == false and task3 == false and task4 == true and task == false)
        {
            ...
            G.v = true; G.draw();
            nA = 0; nP = 0; nAl = 0; nC = 0;
            DI.x = 550; DI.y = 475; DI.r = 50; DI.v = true; DI.text = "Теперь последнее задание"; DI.draw();
            txSleep(2500);
            DI.text = "Теперь собери все цветы!"; DI.draw();
            txSleep(5000);
            DI.v = false; G.v = false;
            time = 600;
            task = true;
        ...
        if(task1 == true and task == true)
        {
            ...
            {
                G.v = true; G.draw();
                DI.v = true; DI.text = "У тебя не получилось"; DI.draw();
                txSleep(1500);
                nA = 0; nP = 0; nAl = 0; nC = 0;
                time = 300;
                task = false;
        ...
        if(task4 == true and task == true)
        {
            ...
            {
                G.v = true; DI.v = true; G.draw();
                DI.text = "Молодец, теперь подведем итоги\n" "пойдем домой"; DI.draw();
                txSleep(2500);
                point ++;
                task4 = false;
                done = true;
            ...
            {
                G.v = true; G.draw();
                DI.v = true; DI.text = "У тебя не получилось, теперь подведем итоги\n" "пойдем домой"; DI.draw();
                txSleep(2500);
                task4 = false;
                done = true;
                page = "dom";
